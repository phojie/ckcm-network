...
<v-app style="overflow-scroll" >
   ...
   <v-toolbar flat dark color="transparent">
      ...
      <v-toolbar-title style="margin-left:38px" class="align-left">
         <v-avatar tile size="40">
            <img src="jieIcons/apple-touch-icon.png">
         </v-avatar>
         <span style="margin-left:-2px;font-size:15px" class=" textfm6">Christ the King Network </span> 
         <div style="margin-top:-15px;margin-left:90px;font-size:14px;position:absolute" class="textfm5">Developed for Ckcmians</div>
      </v-toolbar-title>
      <v-spacer></v-spacer>
